 ...
 * @property front_shiny URL de la imagen frontal shiny del Pokémon.
 * @property front_shiny_female URL de la imagen frontal shiny femenina del Pokémon.
 * @property back_default URL de la imagen trasera por defecto del Pokémon.
 * @property back_female URL de la imagen trasera femenina del Pokémon.
 * @property back_shiny URL de la imagen trasera shiny del Pokémon.
 * @property back_shiny_female URL de la imagen trasera shiny femenina del Pokémon.
 * @property other Colecciones alternativas de sprites oficiales.
 * @property versions Sprites específicos por generación de juegos.
 */
data class Sprites(
    // Default sprites
